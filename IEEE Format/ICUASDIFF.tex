...
%		\DIFaddendFL \centering
%		\DIFdelbeginFL %DIFDELCMD < \includegraphics[width=7cm]{wait}
%%DIFDELCMD < 	%%%
...
%%DIFDELCMD < 	\centering
%%DIFDELCMD < 	\includegraphics[width=7cm]{intercept}
%%DIFDELCMD < 	%%%
%%DIFDELCMD < \caption{%
%{%DIFAUXCMD
...
%%DIFDELCMD < \begin{figure}[H]
%%DIFDELCMD < 	\centering
%%DIFDELCMD < 	\includegraphics[width=7cm]{follow}
%%DIFDELCMD < 	%%%
%%DIFDELCMD < \caption{%
%{%DIFAUXCMD
...
%	\DIFaddbeginFL \begin{subfigmatrix}{2}%DIF >  number of columns
%		\DIFaddendFL \centering
%		\DIFdelbeginFL %DIFDELCMD < \includegraphics[width=7cm]{Rinit07new.png}
%%DIFDELCMD < 	%%%
